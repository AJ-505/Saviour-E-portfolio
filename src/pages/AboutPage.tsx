      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <section className="mb-16 overflow-hidden">
          ...
          <div className="relative">
            {/* Gradient Masks */}
            <div className="absolute left-0 top-0 bottom-0 w-5 sm:-32 bg-gradient-to-r from-background to-transparent z-10"></div>
            <div className="absolute right-0 top-0 bottom-0 w-5 sm:w-32 bg-gradient-to-l from-background to-transparent z-10"></div>
...
function ToolCard({
  ...
  return (
    <div
      className={`flex-none w-72 rounded-xl p-6 transition-all hover:scale-100 hover:shadow-lg group ${color} backdrop-blur-sm`}
    >
